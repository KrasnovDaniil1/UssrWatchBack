...
9. Добавить alembic
10. Реализовать обработку ошибок с временем
11. Продумать минимальные и максимальные значени хранения String(50)
12. Добавить сортировку по количеству коллекци в большую и меньшую сторону
13. Добавить количество часов и механизмов в коллекции по каждым лотам (кол. часов и механизмов можно получать в seed_data)
14. Добавить сортировку в часах по заводам
15. Добавить сортировку по функциям механизма в часах
16. Добавить обновление seed data через alembic/api ?
17. Сделать проверку на gender 
18. Добавить больше параметров (ширина ушек, размерыкорпуса, размеры стекла)
